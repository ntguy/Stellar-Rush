...
export const matEnemy    = new THREE.MeshPhysicalMaterial({ color: 0xff3355, flatShading: true, roughness: 0.4, metalness: 0.7, clearcoat: 1.0 });   // enemy body
...
export const matShield   = new THREE.MeshPhongMaterial({ color: 0x33aaff, flatShading: true, transparent: true, opacity: 0.5 }); // shield pickup
